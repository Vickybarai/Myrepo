...
<div align="center">
  ...
  <!-- Name + Role -->
  <h1 style="color:#e6edf3; font-size: 2em;">
...
<!-- ================= ABOUT ================= -->
<div style="background-color:#161b22; border-radius:12px; padding:25px; margin-bottom:30px; border:1px solid #30363d;">
  <h2 style="color:#2ea44f; border-bottom:1px solid #30363d; padding-bottom:10px;">🚀 About Me</h2>
...
<div align="center">
  <img src="https://stemettes.org/zine/wp-content/uploads/sites/3/2021/08/DEVOPS.gif" 
       ...
       width="600" 
       style="border-radius:12px; box-shadow:0 6px 20px rgba(0,0,0,0.25); max-width:100%;" />
  <div style="font-weight:bold; margin-top:15px; color:#e6edf3; letter-spacing:1px;">
...
<!-- ================= SKILLS ================= -->
<div style="background-color:#161b22; border-radius:12px; padding:25px; margin-bottom:30px; border:1px solid #30363d;">
  <h2 style="color:#2ea44f; border-bottom:1px solid #30363d; padding-bottom:10px;">🛠️ Skills & Tools</h2>
...
<!-- ================= PROJECTS ================= -->
<div style="background-color:#161b22; border-radius:12px; padding:25px; margin-bottom:30px; border:1px solid #30363d;">
  <h2 style="color:#2ea44f; border-bottom:1px solid #30363d; padding-bottom:10px;">🏗️ Projects</h2>

  <h3 style="color:#e6edf3;">🐳 Containerized Web Application</h3>
  <ul style="color:#8b949e; margin-bottom:15px;">
  ...
  <h3 style="color:#e6edf3;">🔄 CI/CD Pipeline Automation</h3>
  <ul style="color:#8b949e; margin-bottom:15px;">
  ...
  <h3 style="color:#e6edf3;">☸️ Kubernetes Deployment (Learning Project)</h3>
  <ul style="color:#8b949e; margin-bottom:15px;">
  ...
  <h3 style="color:#e6edf3;">🏗️ Infrastructure Automation with Terraform</h3>
...
<!-- ================= BADGES & TOOLS ================= -->
<div align="center" style="background-color:#161b22; border-radius:12px; padding:25px; margin-bottom:30px; border:1px solid #30363d;">
  <h2 style="color:#2ea44f;">🚀 DevOps Skills & Tools</h2>
...
<!-- ================= GITHUB STATS ================= -->
<div align="center">
  <h2 style="color:#e6edf3;">📊 GitHub Stats</h2>
...
<p align="center" style="color:#2ea44f; font-style:italic; font-size:1.1em;">
